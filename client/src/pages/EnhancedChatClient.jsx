    ...
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50">
      {!isExpanded ? (
        <Button
          ...
          size="lg"
          className="rounded-full w-14 h-14 bg-purple-600 hover:bg-purple-700 shadow-lg hover:shadow-xl transition-all duration-300"
        >
          ...
          <Card className="w-[380px] shadow-2xl bg-white">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 bg-purple-600 text-white rounded-t-lg">
              ...
              <Button
                ...
                className="h-8 w-8 p-0 hover:bg-purple-500"
              >
