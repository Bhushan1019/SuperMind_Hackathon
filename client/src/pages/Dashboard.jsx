...
const DashboardHeader = ({
  ...
  return <div className="p-4 space-y-4 bg-card rounded-lg shadow-sm"></div>;
};
      ...
      >
        <div className="max-w-7xl mx-auto px-4 py-4">
          <nav className="flex items-center justify-between">
            <Link
              to={"/"}
              className="text-2xl font-bold text-purple-600 cursor-pointer flex gap-4 justify-center items-center"
            >
              <img src="/eye.png" alt="Logo" className="h-10" />
              <p>SocialSights</p>
            </Link>
